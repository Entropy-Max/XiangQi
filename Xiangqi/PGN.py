        ...
        for move in self.CHN.strip().split('\n'):
            ...
            if len(result) == 3: 
                ...
                black_move=black_move[0]+\
                    str(10 - numerals_chinese[black_move[1]]) if black_move[2] == '平' else  str(numerals_chinese[black_move[1]]) +\
                    str(numerals_chinese[black_move[2]])+\
                    str(10 - numerals_chinese[black_move[3]]) if black_move[2] == '平' else  str(numerals_chinese[black_move[3]]) 
